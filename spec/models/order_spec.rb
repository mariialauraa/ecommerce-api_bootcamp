...
RSpec.describe Order, type: :model do
  ...
  #data de vencimento de até 7 dias à frente
  it "#due_date must be 7 days ahead :created_at" do
    subject = create(:order)
    distance_days = (subject.due_date - subject.created_at) / 86400 #segundos de 1 dia
    expect(distance_days).to eq 7
  end

  #o pedido sempre será criado com o status 'processing_order'
