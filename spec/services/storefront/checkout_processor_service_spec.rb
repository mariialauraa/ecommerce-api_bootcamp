...
describe Storefront::CheckoutProcessorService do
  context "when #call" do
    ...
    context "with valid params" do
      ...
      #valor de quanto o usuário pagou no produto
      ...
      it "set Order :subtotal as Line Items #total sum" do
        service = described_class.new(params)
        service.call
        #soma os totais de todos os itens de linha usando o método 'sum' 
        #com um bloco que pega o valor total de cada item '(&:total)'         
      ...
      it "set Order :total_amount as :subtotal with Coupon discount" do
        service = described_class.new(params)
        service.call
        #o resultado é arredondado para 2 casas decimais 'floor(2)'
