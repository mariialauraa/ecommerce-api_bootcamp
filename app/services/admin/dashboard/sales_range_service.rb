  ...
  class SalesRangeService
    ...
    def group_sales_by_month 
      order_filter
        ...
        #mapea o resultado para poder formatar a data
        .map { |record| { date: format_date(*record[0..1]), total_sold: record[2].to_f } }
    end

    #filtra os pedidos pela data de início e fim
    def order_filter
      #associa a 'Order' com o 'line_items'
    ...
    #extrair do campo 'created_at' o mês, o ano e o dia
    def order_arel
